...
const BACKEND_URL = "http://10.32.132.87:5001";
...
const Assistant = () => {
	...
	return (
		<div className="h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex flex-col overflow-hidden">
			{/* Header - Fixed */}
			<header className="fixed top-0 left-0 right-0 z-10 flex items-center gap-4 px-4 py-3 border-b border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
				<Link to="/">
			...
			<div className="flex-1 overflow-y-auto pt-[73px] pb-[140px]">
				{/* Connection Warning */}
				{!isBackendConnected && (
			...
			{/* Input - Fixed */}
			<div className="fixed bottom-0 left-0 right-0 z-10 p-4 border-t border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
